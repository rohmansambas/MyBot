...
await Maria.sendMessage(from, {text: Ayushlod[i], edit: key });
        ...
        if (autobio) {
            Maria.updateProfileStatus(`Hey, future leaders! 🌟 Floiyrine-MD is here to inspire and lead, thanks to Alia Botz, Inc. 🚀 ${runtime(process.uptime())} `).catch(_ => _)
        }
 ...
 *Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
 ...
 break
   ...
   const scritxt = `Script?
    YT : https://youtube.com/@rizalfreall
    Owner : wa.me/6282138388280
    Instagram : instagram.com/zalaliaa
    Telegram : t.me/R1zalFR`
...
case 'delowner':
                if (!isCreator) return reply(mess.owner)
if (!args[0]) return reply(`Use ${prefix+command} nomor\nExample ${prefix+command} 6285808492274`)
...
case 'chatgpt': case 'gpt':{
        ...
        const helptxt = `_*📍[Rules for Floiyrine MD usage]📍*_\n\n\n*>>>* use -support to get the Official group link in your dm.\n\n*--->* If you want to add Floiyrine-MD in your group the contact the owner by *-owner/-mods* \n\n*--->* Dont use wrong command, use the command given in the *-help* list \n\n* Dont spam the bot with commands if Floiyrine-MD is not responding, its means the maybe owner is offline or facing internet issue. \n\n*IF YOU DONT FOLLOW THE RULES THEN YOU WILL BE BANNED* 🚫 \n\n\n*©️ Alia Bots inc* `
      ...
      case "info":
        ...
        let ifx = `🌟『 ⨍ᥣׁׅ֪ᨵׁׅꪱׁׅᨮ꫶ׁׅ֮ꭈׁׅꪱׁׅꪀׁׅꫀׁׅܻ 』🌟
*🌟Description:* A WhatsApp Bot With Rich  features based on Floiyrine 
...
I am *⨍ᥣׁׅ֪ᨵׁׅꪱׁׅᨮ꫶ׁׅ֮ꭈׁׅꪱׁׅꪀׁׅꫀׁׅܻ*, a bot developed by *Alia*.
